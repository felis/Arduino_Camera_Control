...
#ifndef _CAMCONTROLLER_H_
#define _CAMCONTROLLER_H_
...
const char msgPlusMinus[]   PROGMEM = { 0x0B1 };
...
typedef KeyValuePairDataItem<uint8_t, 37, 7>    EXP_COMP_DATA_ITEM;            // Exposure compensation data item type
typedef SRAMValueList<uint8_t, 16>              BKT_STEP_VALUE_LIST;           // Bracketing step value list type

//--- Data Item Types ---------------------------------------------------------
typedef KeyValuePairDataItem<uint8_t, VT_MODE_COUNT, 4>      DIT_MODE;
typedef KeyValuePairDataItem<uint8_t, VT_APT_COUNT, 4>       DIT_APERTURE;
typedef KeyValuePairDataItem<uint8_t, VT_WB_COUNT, 4>        DIT_WB;
typedef KeyValuePairDataItem<uint8_t, VT_SHSPEED_COUNT, 5>   DIT_SHUTTER_SPEED;
typedef KeyValuePairDataItem<uint8_t, VT_PSTYLE_COUNT, 4>    DIT_PSTYLE;
typedef KeyValuePairDataItem<uint8_t, VT_ISO_COUNT, 5>       DIT_ISO;
typedef KeyValuePairDataItem<uint8_t, VT_EXPCOR_COUNT, 7>    DIT_EXPCOR;
typedef IntDataItem<uint8_t, 3>                              DIT_TIMER_DIGIT_PAIR;


#endif //_CAMCONTROLLER_H_
